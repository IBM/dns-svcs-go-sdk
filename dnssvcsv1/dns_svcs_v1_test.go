	...
	Describe(`CreateLoadBalancer(createLoadBalancerOptions *CreateLoadBalancerOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			testServer := httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
				...
				res.Header().Set("Content-type", "application/json")
				res.WriteHeader(200)
				fmt.Fprintf(res, `{"id": "5365b73c-ce6f-4d6f-ad9f-d9c131b26370", "name": "glb.example.com", "enabled": true, "ttl": 120, "health": "DEGRADED", "fallback_pool": "24ccf79a-4ae0-4769-b4c8-17f8f230072e", "default_pools": ["DefaultPools"], "az_pools": {"us-south-1": ["UsSouth1"], "us-south-2": ["UsSouth2"], "us-south-3": ["UsSouth3"], "us-east-1": ["UsEast1"], "us-east-2": ["UsEast2"], "us-east-3": ["UsEast3"], "eu-gb-1": ["EuGb1"], "eu-gb-2": ["EuGb2"], "eu-gb-3": ["EuGb3"], "eu-de-1": ["EuDe1"], "eu-de-2": ["EuDe2"], "eu-de-3": ["EuDe3"], "au-syd-1": ["AuSyd1"], "au-syd-2": ["AuSyd2"], "au-syd-3": ["AuSyd3"], "jp-tok-1": ["JpTok1"], "jp-tok-2": ["JpTok2"], "jp-tok-3": ["JpTok3"]}, "created_on": "2019-01-01T05:20:00.12345Z", "modified_on": "2019-01-01T05:20:00.12345Z"}`)
			}))
	...
	Describe(`ListMonitors(listMonitorsOptions *ListMonitorsOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			testServer := httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
				...
				res.Header().Set("Content-type", "application/json")
				res.WriteHeader(200)
				fmt.Fprintf(res, `{"monitors": [{"id": "5365b73c-ce6f-4d6f-ad9f-d9c131b26370", "name": "healthcheck-monitor", "description": "Health check monitor", "type": "HTTPS", "port": 8080, "interval": 60, "retries": 2, "timeout": 5, "method": "GET", "path": "/health", "allow_insecure": false, "expected_codes": "200", "expected_body": "alive", "follow_redirects": false, "created_on": "2019-01-01T05:20:00.12345Z", "modified_on": "2019-01-01T05:20:00.12345Z"}], "offset": 1, "limit": 20, "count": 1, "total_count": 200, "first": {"href": "https://api.dns-svcs.cloud.ibm.com/v1/instances/434f6c3e-6014-4124-a61d-2e910bca19b1/zones/example.com:d04d3a7a-7f6d-47d4-b811-08c5478fa1a4/load_balancers?page=1&per_page=20"}, "next": {"href": "https://api.pdns.cloud.ibm.com/v1/instances/434f6c3e-6014-4124-a61d-2e910bca19b1/zones/example.com:d04d3a7a-7f6d-47d4-b811-08c5478fa1a4/load_balancers?page=2&per_page=20"}}`)
			}))
	...
	Describe(`CreateMonitor(createMonitorOptions *CreateMonitorOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			testServer := httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
				...
				res.Header().Set("Content-type", "application/json")
				res.WriteHeader(200)
				fmt.Fprintf(res, `{"id": "5365b73c-ce6f-4d6f-ad9f-d9c131b26370", "name": "healthcheck-monitor", "description": "Health check monitor", "type": "HTTPS", "port": 8080, "interval": 60, "retries": 2, "timeout": 5, "method": "GET", "path": "/health", "allow_insecure": false, "expected_codes": "200", "expected_body": "alive", "follow_redirects": false, "created_on": "2019-01-01T05:20:00.12345Z", "modified_on": "2019-01-01T05:20:00.12345Z"}`)
			}))
