...
func TestDnsLoadBalancerOperation(t *testing.T) {
	...
	origin1 := new(dnssvcsv1.OriginInput)
	...
	createDnsGlbPoolOptions.SetOrigins([]dnssvcsv1.OriginInput{*origin1})
	...
	origin2 := new(dnssvcsv1.OriginInput)
	...
	updateDnsGlbPoolOptions.SetOrigins([]dnssvcsv1.OriginInput{*origin2})
